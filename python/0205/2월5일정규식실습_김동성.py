...
r= re.compile('[0-9]{8,}')##Password 정규식
while True :
...
r= re.compile('[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}')##일반전화번호 정규식
while True :
    str = input("일반전화번호입력")
    if r.search(str) == None:
         print("잘못입력")
...
r= re.compile('01[0-9]-[0-9]{4}-[0-9]{4}')##핸드폰 번호 정규식
while True :
    str = input("핸드폰번호입력")
    if r.search(str) == None:
         print("잘못입력")
...
r= re.compile('[a-zA-Z0-9]{8,}@[a-zA-Z0-9]+')##e-mail 정규식
while True :
    str = input("E-mail입력")
    if r.search(str) == None:
         print("잘못입력")
...
r= re.compile('[0-9]{6}-[1-4][0-9]{6}')##주민번호 정규식
while True :
    str = input("주민번호입력")
    if r.search(str) == None:
         print("잘못입력")
